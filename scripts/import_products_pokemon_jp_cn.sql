...
-- ============================================
-- Bulk Pokemon JP+CN import — sheet POKEMONJP (gid=0)
-- 52 unique products generated
-- ============================================
...
('Pokemon', 'Pack', 'Booster Pack', 'Black Bolt Deluxe Pack', 'JP', false, NULL),
...
('Pokemon', 'Pack', 'Booster Pack', 'Cyber Judge Booster Packs', 'JP', false, NULL),
...
('Pokemon', 'Sealed', 'Booster Box', 'Pokemon 151 Chinese Booster Box', 'CN', true, 30),
('Pokemon', 'Sealed', 'Booster Box', 'Gem 3 Booster Box', 'CN', true, 30),
('Pokemon', 'Sealed', 'Special', '151 Coin Set', 'CN', false, NULL),
('Pokemon', 'Sealed', 'Booster Box', '151 Gathering Slim Booster Box Sealed', 'CN', true, 30),
('Pokemon', 'Sealed', 'Booster Box', '151C Surprise Slim Booster Box', 'CN', true, 30),
('Pokemon', 'Sealed', 'Booster Box', 'Chinese Gem Vol.3 Booster Box', 'CN', true, 30),
('Pokemon', 'Sealed', 'Special Box', 'Chinese Pokemon Gem Vol.2 Box', 'CN', false, NULL),
('Pokemon', 'Sealed', 'Booster Box', 'CSV5C Black Crystal Blaze Chino Booster Box', 'CN', true, 30),
('Pokemon', 'Sealed', 'Booster Box', 'CSV5C Dark Crystal Blaze Jumbo Booster Box Fat', 'CN', true, 30)
