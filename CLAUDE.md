...
- **⏳ 还剩 84 个。** 下一批难在没有 TCG 线:`Gem Pack Vol 6 [CN] 135` · `Rarity Collection [JP] 116` · `Nivel Arena [JP] 71` —— **CN 在 TCG 上完全不存在,JP 冷门套也多半没有**,要走官方站/eBay,而且每一张都要人过目。
